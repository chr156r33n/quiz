  ...
  },
{
    id: 'module3',
    title: 'Module 3',
    csv: '/assets/module3/questions.csv',
    config: {
      mainTitle: "BigQuery Pro Module 3 Quiz ",
      welcomeMessage: "It is time to put your new knowledge to the test! I don't have to, and there is no pressure, but we encourage you to take the quiz to make sure you understood and remember the key information we provided.",
      currentQuizText: "Module 3 Quiz:",
      questionsText: "Questions",
      multipleChoiceFormat: '',
      startButton: "Start Quiz",
      quizResultsTitle: "Quiz Results",
  ...
  },
{
    id: 'module4',
    title: 'Module 4',
    csv: '/assets/module4/questions.csv',
    config: {
      mainTitle: "BigQuery Pro Module 4 Quiz ",
      welcomeMessage: "It is time to put your new knowledge to the test! I don't have to, and there is no pressure, but we encourage you to take the quiz to make sure you understood and remember the key information we provided.",
      currentQuizText: "Module 4 Quiz:",
      questionsText: "Questions",
      multipleChoiceFormat: '',
      startButton: "Start Quiz",
      quizResultsTitle: "Quiz Results",
  ...
  },
{
    id: 'module5',
    title: 'Module 5',
    csv: '/assets/module5/questions.csv',
    config: {
      mainTitle: "BigQuery Pro Module 5 Quiz ",
      welcomeMessage: "It is time to put your new knowledge to the test! I don't have to, and there is no pressure, but we encourage you to take the quiz to make sure you understood and remember the key information we provided.",
      currentQuizText: "Module 3 Quiz:",
      questionsText: "Questions",
      multipleChoiceFormat: '',
